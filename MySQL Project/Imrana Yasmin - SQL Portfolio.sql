...
-- Q2: Find the addresses from Canada:
SELECT * FROM t_A2 WHERE C_country = "Canada";
...
-- Q: What is the avegrage running time of all the films in the sakila Database?
...
-- Q.2b. Find all the actors whoes last name contains the letters GEN:
...
-- Q.2c. Find all the actors whoes last name contains the letters LI. This time, order the rows by the last name and first name, in that order. 
...
-- Q.7c. You want run an e-mail marketing campaign in Canada, fow that you will need the names 
